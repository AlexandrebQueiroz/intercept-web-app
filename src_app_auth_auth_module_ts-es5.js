(function () {
  ...
  (self["webpackChunkngx_admin"] = self["webpackChunkngx_admin"] || []).push([["src_app_auth_auth_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _LoginComponent = /*#__PURE__*/function (_nebular_auth__WEBPAC) {
        _inherits(_LoginComponent, _nebular_auth__WEBPAC);

        var _super = _createSuper(_LoginComponent);
        ...
        return _createClass(_LoginComponent);
      }(_nebular_auth__WEBPACK_IMPORTED_MODULE_1__.NbLoginComponent);

      _LoginComponent.ɵfac = /*@__PURE__*/function () {
        var ɵLoginComponent_BaseFactory;
        return function LoginComponent_Factory(t) {
          return (ɵLoginComponent_BaseFactory || (ɵLoginComponent_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetInheritedFactory"](_LoginComponent)))(t || _LoginComponent);
        };
      }();
