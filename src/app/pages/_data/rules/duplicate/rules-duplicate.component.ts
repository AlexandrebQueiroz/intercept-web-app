...
@Component({
  selector: 'rules-duplicate',
  templateUrl: './rules-duplicate.component.html',
})
export class RulesDuplicateComponent {
  ...
  public onSubmit(): void {
    ...
    this.service.save(this.form.value).subscribe(
      ()=>{
        this.toastrService.success(`Sucesso`, `O registro foi Duplicado`);
